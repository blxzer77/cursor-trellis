---
name: start
description: "Enters or refreshes Trellis Framework Context by reading workflow guides, selected task state, Task Dashboard, git status, and project guidelines from .trellis/. Use when beginning a new coding session, selecting a task, creating a task, or re-establishing project context."
---
