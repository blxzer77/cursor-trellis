#!/usr/bin/env python3
"""
Standalone reader for .pactile/config.yaml.
...
CONFIG_REL_PATH = ".pactile/config.yaml"
...
def read_pactile_config(repo_root: Optional[Path] = None) -> dict:
    """Read .pactile/config.yaml. Returns {} on missing or malformed file."""
