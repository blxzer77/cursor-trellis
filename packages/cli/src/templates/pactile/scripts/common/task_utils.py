...
def resolve_task_dir(target_dir: str, repo_root: Path) -> Path:
    ...
    - Relative path: .pactile/tasks/01-31-my-task
    ...
    # Relative path (contains path separator or starts with .pactile)
    if "/" in normalized or normalized.startswith(".pactile"):
...
if __name__ == "__main__":
    ...
    print(f"is_safe_task_path('.pactile/tasks/test'): {is_safe_task_path('.pactile/tasks/test', repo)}")
