...
POOL_README = TEMPLATES / "pactile" / "pool" / "README.md"
INTAKE_CONTRACT = TEMPLATES / "pactile" / "modules" / "intake-basic" / "contract.md"
CANDIDATE_CONTRACT = TEMPLATES / "pactile" / "modules" / "candidate-pool" / "contract.md"
CHECK_CONTRACT = TEMPLATES / "pactile" / "modules" / "independent-check" / "contract.md"
