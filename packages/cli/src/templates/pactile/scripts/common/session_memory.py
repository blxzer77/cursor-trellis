#!/usr/bin/env python3
"""
Search Pactile workspace session memory.

This module parses `.pactile/workspace/<developer>/journal-*.md` files written
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Search Pactile session memory journals.")
