#!/usr/bin/env python3
"""
Search durable Pactile markdown artifacts.

This module is intentionally dependency-free because it is generated into user
projects as part of the Pactile Python runtime.
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Search local .pactile markdown artifacts.",
    )
    parser.add_argument(
        "--query",
        "-q",
    ...
    parser.add_argument(
        "--root",
        help="Repository root. Defaults to nearest parent containing .pactile/.",
    )
