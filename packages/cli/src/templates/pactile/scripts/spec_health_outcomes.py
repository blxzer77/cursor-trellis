...
See .pactile/spec/guides/durable-learning-decision-guide.md for outcome definitions.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--root",
        type=Path,
        default=Path(".pactile/tasks/archive"),
        help="Archive root to scan (default: .pactile/tasks/archive)",
    )
