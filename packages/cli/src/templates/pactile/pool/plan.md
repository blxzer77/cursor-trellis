...
- **Release tracks** (when this repo ships PACTILE): the workflow package and optional BYOK are independent ships. See `.pactile/framework/release-boundary.md`. Do not treat BYOK as a workflow-package gate.
