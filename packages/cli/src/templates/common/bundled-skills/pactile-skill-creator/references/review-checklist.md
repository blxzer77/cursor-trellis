...
- [ ] Project-private rules are in `.pactile/spec/` or a project-local skill, not in a public bundled skill.
- [ ] The skill distinguishes local project customization from upstream Pactile source changes.
...
- [ ] `pactile-meta` references route to this skill where useful without duplicating full authoring rules.
