...
export const RETRIEVAL_TELEMETRY_EXAMPLES = {
  ...
  semanticSliceExecutedSuccess: buildTelemetryExample({
    ...
    tools_called: ["Grep", "SemanticSearch", "Grep", "Read"],
    ...
    trap_only: false,
    corroborated_files: [".cstl/framework/retrieval-daily-guide.md"],
    adapter_errors: [],
    candidate_pool_recall: null,
    final_top_k_recall: null,
    answer_score: 6,
  ...
  semanticSliceResourceExhausted: buildTelemetryExample({
    ...
    adapter_errors: [
      {
        adapter: "platform-semantic",
        outcome: "resource_exhausted",
        category: "resource_exhausted",
        message: "Cursor semantic search returned resource_exhausted",
        retryable: false,
