 ...
 *
 * Canonical source: `@blxzer/trellis-core/channel`. This module is
...
import { buildContextEntries } from "@blxzer/trellis-core/channel";
import type { ContextEntry } from "@blxzer/trellis-core/channel";
