 ...
 *
 * Canonical source: `@blxzer/pactile-core/channel`. This module is
...
import { buildContextEntries } from "@blxzer/pactile-core/channel";
import type { ContextEntry } from "@blxzer/pactile-core/channel";
