 ...
 *
 * Canonical source: `@blxzer/cursor-trellis-core/channel`. This module is
...
import { buildContextEntries } from "@blxzer/cursor-trellis-core/channel";
import type { ContextEntry } from "@blxzer/cursor-trellis-core/channel";
