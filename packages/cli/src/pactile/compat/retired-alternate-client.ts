 ...
 *
 * Cursor++ product surfaces are no longer shipped. On `pactile update`, delete
...
import { computeHash, removeHash } from "../../utils/template-hash.js";
import { resolveWorkflowDirName } from "../../utils/workflow-dir.js";
...
/** Canonical call-site name for the 0.5.x legacy residue cleaner. */
export const cleanupRetiredAlternateClientResidue = cleanupCursor2plusResidue;
