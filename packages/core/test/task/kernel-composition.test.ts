...
import { validateComposition, neutralKernelExtrasBoundary, type CompositionValidationInput } from "../../src/task/kernel-contract.js";
import { applyKernelCreate } from "../../src/task/kernel-store.js";
import { emptyTaskRecord } from "../../src/task/schema.js";
import { parseTileManifestV1 } from "../../src/pactile/tile.js";
...
describe("Host-neutral composition validation", () => {
  ...
  it("keeps registry knowledge at the legacy projection boundary, not neutral business logic", () => {
    const sourceDir = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../../src/task");
