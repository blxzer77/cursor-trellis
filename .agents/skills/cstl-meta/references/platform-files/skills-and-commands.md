...
- Multi-file bundled skills: `cstl-meta`, `smart-search-cli`, and `cstl-micro-grill`.
...
1. **Keep entry files short; references carry long content**. This matters especially for multi-file skills like `cstl-meta`.
