...
description: |
  ...
  Inherits from cstl-meta for base architecture documentation.
...
This skill documents all customizations made to Trellis in this project. For vanilla Trellis documentation, see the `cstl-meta` skill.
