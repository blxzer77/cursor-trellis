...
- [ ] Update `.pactile/spec/guides/` thinking guides
- [ ] Update relevant `.pactile/spec/` docs
...
2. **Sync templates** - After updating `.pactile/spec/`, sync to `src/templates/markdown/spec/`
