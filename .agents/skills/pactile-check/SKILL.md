...
Follow `.pactile/spec/guides/verification-strength-guide.md` for **graded** validation depth by closeout profile. pactile does **not** mandate red-green TDD or per-function unit tests.
