# Pactile Local Skill Template

Copy this template to create a project-specific `pactile-local` skill.

---

## How to Use

1. Create directory: `mkdir -p .claude/skills/pactile-local`
2. Copy the template below to `.claude/skills/pactile-local/SKILL.md`
...
name: pactile-local
description: |
  Project-specific Pactile customizations for [PROJECT_NAME].
  This skill documents all modifications made to the vanilla Pactile system.
  Inherits from pactile-meta for base architecture documentation.
  Use this skill to understand what's been customized in this project's Pactile setup.
---

# Pactile Local - [PROJECT_NAME]

## Overview

This skill documents all customizations made to Pactile in this project. For vanilla Pactile documentation, see the `pactile-meta` skill.

## Base Information

| Field | Value |
|-------|-------|
| Pactile Version | X.X.X |
...
#### /pactile:command-name [ALL]
- **File**: `.claude/commands/pactile/command-name.md`
...
#### Category Name
- **Path**: `.pactile/spec/category-name/`
- **Files**: [list of files]
...
#### spec-name.md
- **Path**: `.pactile/spec/category/spec-name.md`
- **Change**: [what was changed]
- **Date**: YYYY-MM-DD
- **Reason**: [why it was changed]
-->
...
Document any special steps needed when upgrading Pactile.

<!-- Template:
### Upgrade to Pactile X.Y.Z
...
```bash
#!/bin/bash
# create-pactile-local.sh

PROJECT_NAME="${1:-$(basename $(pwd))}"
SKILL_DIR=".claude/skills/pactile-local"
...
name: pactile-local
description: |
  Project-specific Pactile customizations for PROJECT_NAME_PLACEHOLDER.
  This skill documents all modifications made to the vanilla Pactile system.
  Inherits from pactile-meta for base architecture documentation.
---

# Pactile Local - PROJECT_NAME_PLACEHOLDER

## Base Information

| Field | Value |
|-------|-------|
| Pactile Version | $(cat package.json 2>/dev/null | grep version | head -1 | cut -d'"' -f4 || echo "unknown") |
