...
Add a new `/pactile:my-command` command.
...
|------|--------|----------|
| `.claude/commands/pactile/my-command.md` | Create | Yes |
...
Create `.claude/commands/pactile/my-command.md`:
...
**Note**: Cursor commands don't have the `pactile:` prefix.

---

## Step 3: Document in pactile-local
...
1. Run the command: `/pactile:my-command`
