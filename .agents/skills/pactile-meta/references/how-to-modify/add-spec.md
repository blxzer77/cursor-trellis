...
|------|--------|----------|
| `.pactile/spec/mobile/index.md` | Create | Yes |
| `.pactile/spec/mobile/*.md` | Create | Yes |
| Task JSONL templates | Update | Yes |
| `pactile-local/SKILL.md` | Update | Yes |
...
Create `.pactile/spec/mobile/index.md`:
...
def init_mobile_context(task_dir):
    ...
    with open(jsonl_path, "a") as f:
        f.write(json.dumps({
            "file": ".pactile/spec/mobile/index.md",
...
```jsonl
{"file": ".pactile/spec/mobile/index.md", "reason": "Mobile guidelines"}
{"file": ".pactile/spec/mobile/architecture.md", "reason": "Architecture patterns"}
```

---

## Step 5: Document in pactile-local
