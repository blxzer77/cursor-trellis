...
```jsonl
{"file": ".pactile/spec/cli/frontend/index.md", "reason": "Frontend overview"}
{"file": ".pactile/spec/cli/frontend/component-guidelines.md", "reason": "Component patterns"}
```
...
```
1. Read .pactile/spec/{category}/index.md
...
```bash
touch .pactile/spec/cli/frontend/new-pattern.md
```
...
```bash
mkdir .pactile/spec/mobile
```

### 2. Create Index

```bash
touch .pactile/spec/mobile/index.md
```
