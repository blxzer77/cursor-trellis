> Historical note — pre-rename draft (announces the prior `@blxzer/trellis` v0.5.0-beta product line; runtime `.trellis/` and `trellis` command reflect the pre-CSTL-rename state).
